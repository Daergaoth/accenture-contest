...
import com.accenture.hr.slots.SlotService2;
...
public class SlotServiceTest2 {

    private SlotService2 slotService;
    ...
    @BeforeEach
    private void init() {
        slotService = new SlotService2(currentLimit, peopleInside, peopleWaiting);
    }
